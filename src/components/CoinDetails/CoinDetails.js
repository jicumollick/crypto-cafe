  ...
  return (
    <>
      {loading ? (
        ...
        <div className="h-[70vh] px-4 pt-20 pb-24 mx-auto max-w-7xl md:px-2 bg-gray-100">
          <div className="h-full grid grid-cols-1 md:grid-cols-2 justify-items-center gap-4 content-center ">
            <div className="order-2 md:order-1">
              ...
              <h1 className="text-3xl mt-12">Scores: </h1>
              <hr />
            ...
            <div className="flex justify-center items-center order-1 md:order-2">
              <img src={coin.image?.large} alt="Coin_Image" />
            </div>
          </div>
        </div>
      )}
